...
Веб-интерфейс для симуляции инференса больших языковых моделей (LLM) на различных GPU-конфигурациях. Проект основан на открытом симуляторе [InferSim от Alibaba](https://github.com/alibaba/InferSim), доработан для российского рынка и поддерживает модели семейств Qwen, DeepSeek, а также отечественное оборудование MetaX.
